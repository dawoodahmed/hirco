...
<!--                             <div class="col-md-6">
                    ...
                    <form id="product_form" style="" class="form-horizontal" role="form" method="post" action="<?=base_url();?>admin/insert_productdetails" enctype= "multipart/form-data">
                        <div class="col-lg-12">
                            <div class="col-lg-8">
                                <div class="form-group">
                                ...
                                <?php
                                        } else if ($filter_data[0]->value_type == 'Numeric') {
                                ?>
                                    <div class="form-group">
                                        <lable><?=$filter_data[0]->filter_name?></lable>
                                        <input type="number" name="master_txt_<?=$filter_data[0]->id?>" id="master_txt_<?=$filter_data[0]->id?>" class="form-control">
                                    </div>
                                <?php
                                ...
                                <?php
                                        } else if ($filter_data[0]->value_type == 'MultiselectImage') {
                                ?>
                                    <div class="form-group">
                                        <lable><?=$filter_data[0]->filter_name?></lable>
                                        <input type="file" name="master_multi_<?=$filter_data[0]->id?>[]" id="master_multi_<?=$filter_data[0]->id?>" class="" multiple>
                                    </div>
                                <?php
                                        }
                                    }
