...
<body>
    <?php 
		    ...
		    ?>
	<table border="0" width="600" height="450" style="background-image:url(http://pearlsarkar.net/hirco/assets/admin/certificate_image/Fresh_culture.jpg); background-size:cover; background-position:center center; image-repeat: no-repeat; ">
		<tr >
			<td width="10px">
			</td>
			<td  width="300" colspan="3"><font color="white" >
					<font size="22px" style="font-family:Arial, Helvetica, sans-serifs;">ISO 9001:2000<br>
					<font size="15px" style="font-family:Arial, Helvetica, sans-serifs;">Cerified Organisation<br><br>
			...
			<td colspan="1" align="left" ><font color="white">
				
				 <b><font size="22px" style="font-family:Arial, Helvetica, sans-serifs;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;HIRCO</b><br>
					<font size="14px" style="font-family:Arial, Helvetica, sans-serifs;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Enterprises pvt.ltd.<br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Mumbai - India<br>
		...
		<tr>
            ...
            <td align="center" colspan="3" ><font color="white">
				<b><font size="20px" style="font-family:Arial, Helvetica, sans-serifs;">Identification</b>
			</td>
			<td width="300"  align="left" colspan="4"><font color="white">
				<b><font size="20px" style="font-family:Arial, Helvetica, sans-serifs;">&nbsp;&nbsp;<?=$pieces?> <?=$type?></b>
			</td>
        </tr>
		...
		<tr>
			...
			<td><font color="white"><font size="14px" style="font-family:Arial, Helvetica, sans-serifs;"><?=$comment1?></td>
			<td><font color="white"><font size="14px" style="font-family:Arial, Helvetica, sans-serifs;"><?=$comment2?></td>
		...
		<tr>
			...
			<td></td>
			<td><font color="white"><font size="14px" style="font-family:Arial, Helvetica, sans-serifs;"><?=$comment3?></td>
			<td><font color="white"><font size="14px" style="font-family:Arial, Helvetica, sans-serifs;"><?=$comment4?></td>
		...
		<tr>	
			...
			<td width="100px"><font color="white"><font size="15px" style="font-family:Arial, Helvetica, sans-serifs;">&nbsp;&nbsp;&nbsp;Sizes in mm</td>
			<td width="5px"><font color="white"><font size="15px" style="font-family:Arial, Helvetica, sans-serifs;">:&nbsp;&nbsp;<?=$size1?></td>
			<td width="15px" ><font color="white"><font size="15px" style="font-family:Arial, Helvetica, sans-serifs;">&nbsp;&nbsp;<?=$size2?></td>
			<td width="15px"><font color="white"><font size="15px" style="font-family:Arial, Helvetica, sans-serifs;"> &nbsp;&nbsp;<?=$size3?></td>
		</tr>
		...
		<tr>
			...
			<td colspan="2"><font color="white"><font size="15px" style="font-family:Arial, Helvetica, sans-serifs;line-height:20px;">:&nbsp;&nbsp;<?=$drills?></td>
		</tr>
		...
		<tr>
			...
			<td colspan="2"><font color="white"><font size="15px" style="font-family:Arial, Helvetica, sans-serifs;line-height:20px;">:&nbsp;&nbsp;<?=$shape?></td>
		</tr>
		...
		<tr>
			...
			<td colspan="2"><font color="white"><font size="15px" style="font-family:Arial, Helvetica, sans-serifs;line-height:20px;">:&nbsp;&nbsp;<?=$matching?></td>
		</tr>
