...
<body>
	...
	<div class="main-sec" style="background-image: url(http://pearlsarkar.net/hirco/assets/admin/certificate_image/real_bg.jpg); background-size: cover; background-position: 0 0;background-repeat:no-repeat; width: 667.19px; height: 463px; margin-left:2.85%; margin-top: 2.12%;font-family: Arial, Helvetica, sans-serif;font-weight:bold !important;">	
		...
		<div class="wdth80" style="">
			<div class="fltleft wdth53">
				<center><h1 style="margin: 0.5% 0 0 0; margin-left:10%; padding: 0; text-align:center; font-size:1.3em;">Identification</h1></center>
			</div>
		...
		<div class="" style="width:100%;">
			<div class="wdth40 fltleft" style="padding: 0% 2%; margin-left:-2%;">
				<img src="http://pearlsarkar.net/hirco/assets/images/pearl.jpg" width="314.65px" height="236px">
				<div class="wdth50">
					<p style=" font-size:0.75em;margin-left:13px;margin-top:5px;">Copyright &#169 2008.</p> 
				</div>
			</div>
			<div class="fltleft wdth40 " style="padding:0% 2%; margin-left:9%;">
				...
				<div  class=" wdth100">
					...
					<div class="wdth90 fltleft">
						<p style=" font-size:0.8em;  margin:1.5px 0 0 0;">:&nbsp; Not Applicable</p>
	...
	<div class="main-sec" style="background-image: url(http://pearlsarkar.net/hirco/assets/admin/certificate_image/real_bg.jpg); background-size: cover; background-position: 0 0;background-repeat:no-repeat; width: 667.19px; height: 463.22px; margin-left:2.85%; margin-top: 4.24%;font-family: Arial, Helvetica, sans-serif;font-weight:bold !important;">
		<div class="fltleft wdth60">
			<h1 style="margin: 2% 0 0 0 ; font-size:1.3em;">ISO 9001:2008</h1>
			<h4 style="font-size:0.8em;  font-weight:normal;">Certified Organization</h4>
			<h3 style="padding: 0 0 0 0; margin-top: 6%; margin-bottom:0; font-size:0.9em;  font-weight:normal;font-family: Arial, Helvetica, sans-serif;">Testing Certificate No : <?=$id?>
			<br />on the authencity of the following <?=$item?></h3>
		</div>
		<div class="fltleft" style="display:inline-block; width: 23%; margin-left: 13.5%; ">
			<h1 style="margin: 2% 0 0 0;font-size:1.3em">HIRCO</h1>
			<h4 style="font-size:0.8em; font-weight:normal;margin-top:-5%;">Enterprises pvt. ltd.<br>Mumbai - India<br>Website : www.hirco.net<br>Email : info@hirco.net</h4>
		</div>
		<div class="wdth80" style="">
			<div class="fltleft wdth53">
				<center><h1 style="margin: 1% 0 0 0; margin-left:10%; padding: 0; text-align:center; font-size:1.3em;">Identification</h1>
				</center>
			</div>
			<div class="fltleft wdth30">
				<h1 style="margin: 1% 0 0 0; margin-left:15%; padding: 0; text-align:left; font-size:1.3em;"><?=$pieces?>&nbsp;&nbsp;<?=$type?></h1>
			</div>
		</div>	
		<div  class="wdth80">
			<h4 style="padding: 0; margin-top: 1%; margin-bottom:1%;  font-weight:normal; font-size:0.8em;" class="">Comment : comment1 &nbsp;&nbsp;&nbsp;&nbsp; comment2 <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; comment3 &nbsp;&nbsp;&nbsp;&nbsp; comment4</h4>
		</div>
		<div class="" style="width:100%;">
			<div class="wdth40 fltleft" style="padding: 4% 2%; margin-left:-2%;">
				<img src="http://pearlsarkar.net/hirco/assets/images/pearl.jpg" width="314.65px" height="236px">
				<div class="wdth50">
			...
			<div class="fltleft wdth40 " style="padding:0% 2%; margin-left:9%;">
				...
				<div  class=" wdth100">
					...
					<div class="wdth90 fltleft">
						...
						<p style=" font-size:0.77em;margin:18px 0px 0px -20px !important;">See Terms & Conditions on reverse</p> 
					</div>
				</div>
			</div>
		</div>
