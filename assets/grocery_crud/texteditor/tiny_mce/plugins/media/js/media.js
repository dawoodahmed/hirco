	...
	window.Media = {
		...
		moveStates : function(to_form, field) {
			...
			defaultStates = {
				...
				// WindowsMedia
				linuxmedia_autostart : true,
				linuxmedia_enablecontextmenu : true,
				linuxmedia_invokeurls : true,
			...
			get('linuxmedia_options').style.display = 'none';
			...
			setOptions('linuxmedia', 'autostart,enabled,enablecontextmenu,fullscreen,invokeurls,mute,stretchtofit,windowlessvideo,balance,baseurl,captioningid,currentmarker,currentposition,defaultframe,playcount,rate,uimode,volume');
